...
class FeedbackEntry(BaseModel):
    ...
    timestamp: datetime = Field(default_factory=datetime.now, description="Data e hora do feedback")
    user_id: Optional[str] = Field(None, description="ID do usuário que forneceu o feedback")
...
class FeedbackProcessor:
    ...
    def record_feedback(self, interaction_id: str, feedback_type: Union[str, FeedbackType], 
                       value: Any, user_id: Optional[str] = None, 
    ...
    def _apply_feedback(self, feedback: FeedbackEntry) -> None:
        ...
        if feedback.feedback_type in [FeedbackType.EXPLICIT_POSITIVE, FeedbackType.IMPLICIT_POSITIVE]:
            self._apply_positive_reinforcement(feedback)
        elif feedback.feedback_type in [FeedbackType.EXPLICIT_NEGATIVE, FeedbackType.IMPLICIT_NEGATIVE]:
