...
class InteractionEvent(BaseModel):
    ...
    event_type: str = Field(..., description="Tipo de evento (ex: chat, email, ticket, venda)")
    source: str = Field(..., description="Origem do evento (ex: crm, chat, email)")
    timestamp: datetime = Field(default_factory=datetime.now, description="Data e hora do evento")
    ...
    entity_type: Optional[str] = Field(None, description="Tipo de entidade relacionada (ex: cliente, oportunidade)")
