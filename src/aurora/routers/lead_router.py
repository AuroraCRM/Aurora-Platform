...
def listar_leads(skip: int = 0, limit: int = 100, db: Session = Depends(get_db_session)):
    """
...
def atualizar_lead(lead_id: int, lead_update: LeadUpdate, db: Session = Depends(get_db_session)):
    """
