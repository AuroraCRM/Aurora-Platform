        ...
        async with httpx.AsyncClient() as client:
            try:
                ...
                try:
                    ...
                    logger.warning(f"Falha ao decodificar a resposta de {full_url} como UTF-8. Tentando como latin-1.")
                ...
                logger.error(f"Erro de status HTTP ao consultar {full_url}: {e.response.status_code}")
                raise HTTPException(
