...
class ContextEngine:
    ...
    def _load_knowledge(self):
        ...
        try:
            ...
            print(
                f"AVISO: Arquivo de conhecimento '{self.knowledge_file}' não encontrado."
            )
            return {}
    ...
    def __call__(self, task_description: str) -> dict:
        ...
        context = {
            ...
            "knowledge_context": self.knowledge_base.get(
                "general_info", "Nenhum contexto adicional disponível."
            ),
        }
        return context
