...
from aurora.models.cliente_model import ClienteDB  # garante que o modelo seja carregado
...
def run_migrations_online():
    """Execute as migrações em modo 'online' (aplica direto no DB)."""
...
# Dispara o modo adequado conforme o contexto
